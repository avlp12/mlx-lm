...
class MoEGate(nn.Module):
    ...
    def __call__(self, x):
        # Match the reference implementation: the router matmul runs in fp32
        # (transformers: F.linear(hidden.float(), weight.float())). Near-tie
        # top-8 selection under sigmoid+bias is sensitive to bf16 matmul noise.
